...
public class MailingListServiceImpl{
	...
	private static MailingListServiceImpl mailingListServiceImpl;

	private MailingListServiceImpl() {
		super();
	}
	
	public static MailingListServiceImpl getInstance(){
		if(mailingListServiceImpl == null){
			mailingListServiceImpl = new MailingListServiceImpl();
		}
		return mailingListServiceImpl;
	}
