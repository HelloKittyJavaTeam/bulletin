...
public class VehicleFamilyServiceImpl{
	VehicleFamilyRepository vehicleFamilyRepository = new VehicleFamilyRepositoryImpl();
	private static VehicleFamilyServiceImpl vehicleFamilyServiceImpl;

	private VehicleFamilyServiceImpl() {
		super();
	}
	
	public static VehicleFamilyServiceImpl getInstance(){
		if(vehicleFamilyServiceImpl == null){
			vehicleFamilyServiceImpl = new VehicleFamilyServiceImpl();
		}
		return vehicleFamilyServiceImpl;
	}
