...
public class TechAreaDeptServiceImpl{
	TechAreaDeptRepository techAreaDeptRepository = new TechAreaDeptRepositoryImpl();
	private static TechAreaDeptServiceImpl techAreaDeptServiceImpl;

	private TechAreaDeptServiceImpl() {
		super();
	}
	
	public static TechAreaDeptServiceImpl getInstance(){
		if(techAreaDeptServiceImpl == null){
			techAreaDeptServiceImpl = new TechAreaDeptServiceImpl();
		}
		return techAreaDeptServiceImpl;
	}
