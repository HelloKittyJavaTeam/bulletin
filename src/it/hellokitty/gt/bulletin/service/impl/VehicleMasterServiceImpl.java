...
public class VehicleMasterServiceImpl{
	VehicleMasterRepository vehicleMasterRepository = new VehicleMasterRepositoryImpl();
	private static VehicleMasterServiceImpl vehicleMasterServiceImpl;

	private VehicleMasterServiceImpl() {
		super();
	}
	
	public static VehicleMasterServiceImpl getInstance(){
		if(vehicleMasterServiceImpl == null){
			vehicleMasterServiceImpl = new VehicleMasterServiceImpl();
		}
		return vehicleMasterServiceImpl;
	}
